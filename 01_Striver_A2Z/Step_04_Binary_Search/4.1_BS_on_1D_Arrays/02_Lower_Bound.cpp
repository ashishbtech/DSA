...
int main()
{
    ...
    cout << "1. Brute Force : Index " << obj.lowerBoundBrute(arr, target) << "\n";
    cout << "2. Optimal     : Index " << obj.lowerBoundOptimal(arr, target) << "\n";
    cout << "3. STL 1-Liner : Index " << obj.lowerBoundSTL(arr, target) << "\n";
